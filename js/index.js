document.addEventListener('DOMContentLoaded', function() {
    // Array de objetos contendo os links do menu de navegação
    const menuLinks = [
    ...
    // Função que formata e gera HTML do menu de navegação
    function formatarMenu(links) {
        let menuHTML = '';
        // Percorre cada link e cria elementos HTML
        links.forEach(link => {
    ...
    // Permite fechar alertas de erro pressionando a tecla ESC
